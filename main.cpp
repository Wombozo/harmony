...
void initialize()
{
    NaturalNote *rA = new NaturalNote("A", "La", 1);
    ...
    NaturalNote *rB = new NaturalNote("B", "Si", 3);
    ...
    NaturalNote *rC = new NaturalNote("C", "Do", 4);
    ...
    NaturalNote *rF = new NaturalNote("F", "Fa", 9);
    ...
    NaturalNote *rG = new NaturalNote("G", "Sol", 11);
